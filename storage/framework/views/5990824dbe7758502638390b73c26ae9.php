<div class="max-w-4xl mx-auto p-4 space-y-6">
    ...
    <div class="flex items-center justify-between">
        ...
        <!--[if BLOCK]><![endif]--><?php if($this->isSubmitted): ?>
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-4">
        <div class="flex items-center justify-between">
            <button wire:click="$set('weekOffset', <?php echo e($weekOffset - 1); ?>)" 
                    ...
                    <?php if($weekOffset <= 0): echo 'disabled'; endif; ?>>
                ...
                <select wire:model.live="weekOffset" class="text-sm font-medium border-0 bg-transparent focus:ring-0 text-center cursor-pointer">
                    <!--[if BLOCK]><![endif]--><?php for($i = 0; $i <= 4; $i++): ?>
                        <option value="<?php echo e($i); ?>">
                            <?php echo e($i === 0 ? 'Minggu Ini' : ($i === 1 ? 'Minggu Depan' : "$i Minggu Lagi")); ?>

                        </option>
                    <?php endfor; ?><!--[if ENDBLOCK]><![endif]-->
                </select>
                <p class="text-sm text-gray-500 mt-1"><?php echo e($this->weekLabel); ?></p>
            </div>
            
            <button wire:click="$set('weekOffset', <?php echo e($weekOffset + 1); ?>)" 
                    class="p-2 text-gray-500 hover:text-gray-700 hover:bg-gray-100 rounded-lg transition-colors disabled:opacity-40 disabled:cursor-not-allowed" 
                    <?php if($weekOffset >= 4): echo 'disabled'; endif; ?>>
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="grid grid-cols-3 gap-4">
        <div class="bg-white rounded-xl border border-gray-200 p-4 text-center">
            <span class="text-2xl font-bold text-blue-600"><?php echo e($this->totalSelected); ?></span>
            <p class="text-sm text-gray-500 mt-1">Sesi Dipilih</p>
        </div>
        <div class="bg-white rounded-xl border border-gray-200 p-4 text-center">
            <span class="text-2xl font-bold text-green-600"><?php echo e($this->totalSelected * 3); ?></span>
            <p class="text-sm text-gray-500 mt-1">Jam</p>
        </div>
        <div class="bg-white rounded-xl border border-gray-200 p-4 text-center">
            <span class="text-2xl font-bold text-purple-600"><?php echo e($this->totalSelected); ?>/12</span>
        ...
        <table class="w-full">
            <thead class="bg-gray-50 border-b border-gray-200">
                <tr>
                    ...
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $this->sessions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $time): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <th class="py-3 px-3 text-center text-sm font-semibold text-gray-700">
                            <div>Sesi <?php echo e($key); ?></div>
                            <div class="text-xs font-normal text-gray-400 mt-0.5"><?php echo e($time); ?></div>
                        </th>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                </tr>
            </thead>
            <tbody class="divide-y divide-gray-100">
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $this->days; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dayKey => $dayLabel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="hover:bg-gray-50/50">
                        <td class="py-4 px-4">
                            <!--[if BLOCK]><![endif]--><?php if($this->canEdit): ?>
                                <button type="button" 
                                        wire:click="toggleDay('<?php echo e($dayKey); ?>')"
                                        class="font-medium text-gray-900 hover:text-blue-600 transition-colors">
                                    <?php echo e($dayLabel); ?>

                                </button>
                            <?php else: ?>
                                <span class="font-medium text-gray-900"><?php echo e($dayLabel); ?></span>
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                        </td>
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = array_keys($this->sessions); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sessionKey): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php $isSelected = $grid[$dayKey][$sessionKey] ?? false; ?>
                            <td class="py-4 px-3 text-center">
                                <button type="button"
                                        <?php if($this->canEdit): ?> wire:click="toggle('<?php echo e($dayKey); ?>', '<?php echo e($sessionKey); ?>')" <?php endif; ?>
    ...
    <!--[if BLOCK]><![endif]--><?php if($this->canEdit): ?>
        <div class="flex justify-end">
            <button type="button" 
                    ...
                    <?php if($this->totalSelected === 0): echo 'disabled'; endif; ?>
...
<?php /**PATH C:\laragon\www\Kopma\resources\views/livewire/schedule/availability-manager.blade.php ENDPATH**/ ?>