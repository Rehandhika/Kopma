...
<div class="space-y-1">
    <div class="flex items-start">
        ...
        <div class="ml-2">
            ...
            <label for="<?php echo e($name); ?>" class="text-sm text-gray-700 select-none block">
                <?php echo e($label); ?>

            </label>
            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
            <!--[if BLOCK]><![endif]--><?php if($description): ?>
            <p class="text-xs text-gray-500 mt-0.5"><?php echo e($description); ?></p>
            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
        </div>
        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
    </div>
...
<?php /**PATH C:\laragon\www\Kopma\resources\views/components/ui/checkbox.blade.php ENDPATH**/ ?>