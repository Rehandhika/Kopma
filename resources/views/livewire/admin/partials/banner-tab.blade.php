<div class="space-y-6">
    ...
    @if($showBannerForm)
        <x-ui.card>
            ...
            >
                <form wire:submit.prevent="saveBanner" class="space-y-6">
                    {{-- Title Field --}}
                    <div>
                        ...
                        <input 
                            ...
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('bannerTitle') border-red-500 @enderror"
                        >
                        @error('bannerTitle')
                    ...
                    <div>
                        ...
                        @if($editingBannerId && !$bannerImagePreview)
                            @php
                        ...
                        <input 
                            ...
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('bannerImage') border-red-500 @enderror"
                        ...
                        {{-- Loading indicator --}}
                        <div wire:loading wire:target="bannerImage" class="mt-2">
                    ...
                    {{-- Priority Field --}}
                    <div>
                        <label for="bannerPriority" class="block text-sm font-medium text-gray-700 mb-2">
                            Prioritas
                        </label>
                        <input 
                            type="number" 
                            wire:model="bannerPriority"
                            id="bannerPriority"
                            min="0"
                            placeholder="0"
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('bannerPriority') border-red-500 @enderror"
                        >
                        @error('bannerPriority')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
